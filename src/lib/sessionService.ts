  ...
  await runTransaction(db, async (tx) => {
    ...
    if (auctionEngine.shouldEndAuction({ queueIndex: nextIndex, queueLength: auctionQueue.length, teamSquadSizes })) {
      tx.update(sessionRef, {
        ...
        currentAuction: { activePlayerId: null, currentBid: 0, currentBidderId: null, timerEndsAt: null, status: "IDLE", rtmStage: "NONE", rtmTeamId: null, rtmWinningTeamId: null, rtmPlayerId: null, rtmFinalBid: 0, rtmCounterBid: 0, rtmExpiresAt: null },
      });
      return;
    }
  ...
  await runTransaction(db, async (tx) => {
    ...
    if (!winningTeamId) {
      ...
      tx.update(sessionRef, {
        ...
        pendingRtm: null,
        currentAuction: { activePlayerId: playerId, currentBid: finalBid, currentBidderId: null, timerEndsAt: null, status: "UNSOLD", rtmStage: "NONE", rtmTeamId: null, rtmWinningTeamId: null, rtmPlayerId: null, rtmFinalBid: 0, rtmCounterBid: 0, rtmExpiresAt: null },
      });
      return;
    }
    ...
    tx.update(sessionRef, {
      ...
      currentAuction: { activePlayerId: playerId, currentBid: finalBid, currentBidderId: winningTeamId, timerEndsAt: null, status: "SOLD", rtmStage: "NONE", rtmTeamId: null, rtmWinningTeamId: null, rtmPlayerId: null, rtmFinalBid: 0, rtmCounterBid: 0, rtmExpiresAt: null },
    });
  });
};
  ...
  await runTransaction(db, async (tx) => {
    ...
    if ((transition as any).done) {
      ...
      tx.update(sessionRef, {
        ...
        currentAuction: { activePlayerId: pending.playerId, currentBid: Number(result.finalBid), currentBidderId: result.winnerTeamId, timerEndsAt: null, status: "SOLD", rtmStage: "NONE", rtmTeamId: null, rtmWinningTeamId: null, rtmPlayerId: null, rtmFinalBid: 0, rtmCounterBid: 0, rtmExpiresAt: null },
      });
      return;
    }
